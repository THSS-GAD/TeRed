...
def model_train(num_class,output_dir):
    ...
    parser.add_argument('--window-size', type=int, default=3, metavar='N',
    ...
    parser.add_argument('--num-classes', type=int,default=num_class, metavar='N',
                        help='the number of model\'s output, must same as pattern size!')
    parser.add_argument('--num-candidates', type=int,default=num_class//10, metavar='N',
    ...
    parser.add_argument('--current-host', type=str, default='127.0.0.1',
                        help='args for SageMaker distributed training.')
    parser.add_argument('--model-dir', type=str, default=output_dir,
