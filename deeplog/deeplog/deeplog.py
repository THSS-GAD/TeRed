...
def _get_train_data_loader(model_dir,batch_size, is_distributed, window_size, local, **kwargs):
    logger.info("Get train data loader")
    _generate = Generate()
    seq_dataset = _generate.generate(name=model_dir+'/train', window_size=window_size, local=local)
...
def train(args):
    ...
    train_loader = _get_train_data_loader(args.model_dir,args.batch_size, is_distributed, args.window_size, args.local, **kwargs)
