...
class gSpan(object):
    ...
    def run(self):
        ...
        for vevlb, projected in tqdm(root.items()):
    ...
    def _report(self, projected):
        ...
        with open('output.txt','a') as file0:
            print(display_str,file=file0)
            print('\nSupport: {}\n'.format(self._support),file=file0)
